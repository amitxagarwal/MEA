   ...
   public class TaskService : ITaskService
    {
       ...
       public async Task<ResultOrHttpError<TaskDataResponseModel, Error>> UpdateTaskStatusByIdAsync(string id, string taskUpdateStatus)
        {
            var response = await _taskHttpClient.UpdateTaskStatusFromMomentumCoreAsync($"/tasks/{id}/{taskUpdateStatus}").ConfigureAwait(false);
